$(document).ready(function () {
    document.getElementById('breadcrumb').innerHTML = '<li>Developer</li><li>Add Role to User</li>';
    ...
    var t = $('#table1').DataTable({
        ...
        order: [[ 1, 'desc' ]],
        ajax:{
            url: 'listmodelhasroles',
        },
        columns:[
            { "data": "action", "name": "action" },
            { "data": "created_at", "name": "model_has_roles.created_at" },
    ...
    $(document).on('click', '.delete', function(){
        ...
        .then((result) => {
            if (result.isConfirmed) {
                $.ajax({
                    url: 'model-has-roles/destroy/' + id,
                    method: "GET",
                    dataType: "json",
                    beforeSend: function(){
                        Swal.fire({
