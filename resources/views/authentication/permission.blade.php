            ...
            <article class="col-sm-12 col-md-3 col-lg-3">
                ...
                >
                    <header>
                        ...
                        <h2><code>Permission pane</code></h2>
                    </header>
                    <div>
                        ...
                        <div class="widget-body no-padding">
                            ...
                            <form class="smart-form" method="post" id="form1" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <fieldset>
                                    <section>
                                        <label class="input">
                                            <input type="text" name="name" id="name" placeholder="Permission Name" required>
                                            <b class="tooltip tooltip-bottom-right">Enter permission name</b> </label>
                                    </section>
                                </fieldset>
                                <footer>
...
@section('systemJsFile')
    <script src="{{ asset('/js/system-scripts/authentication/permissions.js') }}"></script> 
@stop