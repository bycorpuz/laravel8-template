            ...
            <article class="col-sm-12 col-md-3 col-lg-3">
                ...
                >
                    <header>
                        ...
                        <h2><code>Add permission to user pane</code></h2>
                    </header>
                    <div>
                        ...
                        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            >
                                <header>
                                    ...
                                    <h2>User Permissions Data Table </h2>
                                </header>
                                <div>
                                    <div class="jarviswidget-editbox">
                                    </div>
...
@section('systemJsFile')
    <script src="{{ asset('/js/system-scripts/authentication/model-has-permissions.js') }}"></script> 
@stop